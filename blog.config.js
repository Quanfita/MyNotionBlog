...
const BLOG = {
  AUTHOR: 'Quanfita', // 作者
  BIO: '博学至臻，大道至简', // 作者简介
  LINK: 'https://quanfita.cn', // 网站地址
  KEYWORDS: 'Notion, 博客, Quanfita, QTechCode', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'd57aa007e19b46678e950a4afb2d790b', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'qumengnan@quanfita.cn',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: 'https://twitter.com/quanfita',
  CONTACT_GITHUB: 'https://github.com/Quanfita',
  CONTACT_TELEGRAM: '',
